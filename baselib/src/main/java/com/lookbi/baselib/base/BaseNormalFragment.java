...
public abstract class BaseNormalFragment<V, P extends BasePresenterImpl<V>> extends Fragment {
...
//        LogUtil.e("isPrepared=" + isPrepared + ",isVisible=" + isVisible + ",isFirst=" + isFirst);
